...
>
    ...
    <tr key={index + 1}> {/* Increment index to start from 1 */}
      ...
      <td>
        <img 
          ...
          alt={data['product_name']} // Set a meaningful alt text
      ...
      <td style={{ width: '20%' }}>
        <Link 
          to={`/seller/edit_product/${data['id']}`} // Ensure the link is correct
          className="edit-btn" 
        ...
        <a 
          ...
          onClick={(e) => {
            ...
            handleDeleteItem(data['id']); // Call the delete handler
          }}
        >
  ...
  <tr>
    <td colSpan={9} style={{ textAlign: 'center' }}>No Product available.</td> {/* Adjust colSpan based on your table structure */}
  </tr>
)}
